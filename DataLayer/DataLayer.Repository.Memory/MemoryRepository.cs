...
namespace DataLayer.Repository.Memory
{
    public class MemoryRepository : IRepository
    {
        ...
        private static List<ProductGroup> productGroups = null;
        ...
        {
            return _Products.Select(p=>p.Brand).Distinct().AsQueryable();
        }
        ...
        public IQueryable<Review> Reviews(int productID)
        {
            ...
            revs.AddRange(_Reviews.Where(r=>r.ProductID == productID).ToList());
        ...
        public IQueryable<Specification> Specifications(int productID)
        {
            ...
            if (pp != null)
            {
                return pp.Specifications.AsQueryable();
            }
            return null;
        }
    }
